...
namespace Squiggle.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (http://squiggle-api.sitlabs.co.uk/).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("http://squiggle-api.sitlabs.co.uk/");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://squiggle-api.sitlabs.co.uk/).
        /// </summary>
